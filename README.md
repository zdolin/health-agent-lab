...
A modular AI multi-agent orchestration prototype using [Strands Agents](https://strandsagents.com/latest/), FastAPI, and AWS Bedrock to simulate clinical reasoning tasks with modular, callable tools. Integrates with the [openFDA API](https://open.fda.gov/) for evidence-based medication information.
