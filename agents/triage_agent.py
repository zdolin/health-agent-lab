...
triage_agent = Agent(
    model=bedrock_model,
    system_prompt="""You are a medical triage assistant. Given a patient's description of symptoms, extract medications or health-related terms and assess risk level. Keep your response concise and structured as:
